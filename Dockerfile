...
# Google Analytics 4 measurement ID (G-XXXXXXXXXX). Inlined at build time
# like every NEXT_PUBLIC_ variable; unset, GA is simply not loaded.
ARG NEXT_PUBLIC_GA_MEASUREMENT_ID
ENV NEXT_PUBLIC_GA_MEASUREMENT_ID=${NEXT_PUBLIC_GA_MEASUREMENT_ID}
ARG NEXT_PUBLIC_STATS_DASHBOARD_URL
ENV NEXT_PUBLIC_STATS_DASHBOARD_URL=${NEXT_PUBLIC_STATS_DASHBOARD_URL}
# Adsterra. Left unset, every ad slot renders nothing at all (see
# lib/adsterra.ts's useAdsAllowed) — which is what a build without these
# should do, rather than leaving holes where an ad was meant to be.
ARG NEXT_PUBLIC_ADSTERRA_BANNER_KEY
ENV NEXT_PUBLIC_ADSTERRA_BANNER_KEY=${NEXT_PUBLIC_ADSTERRA_BANNER_KEY}
ARG NEXT_PUBLIC_ADSTERRA_BANNER_WIDTH
ENV NEXT_PUBLIC_ADSTERRA_BANNER_WIDTH=${NEXT_PUBLIC_ADSTERRA_BANNER_WIDTH}
ARG NEXT_PUBLIC_ADSTERRA_BANNER_HEIGHT
ENV NEXT_PUBLIC_ADSTERRA_BANNER_HEIGHT=${NEXT_PUBLIC_ADSTERRA_BANNER_HEIGHT}
ARG NEXT_PUBLIC_ADSTERRA_BANNER_MOBILE_KEY
ENV NEXT_PUBLIC_ADSTERRA_BANNER_MOBILE_KEY=${NEXT_PUBLIC_ADSTERRA_BANNER_MOBILE_KEY}
ARG NEXT_PUBLIC_ADSTERRA_BANNER_MOBILE_WIDTH
ENV NEXT_PUBLIC_ADSTERRA_BANNER_MOBILE_WIDTH=${NEXT_PUBLIC_ADSTERRA_BANNER_MOBILE_WIDTH}
ARG NEXT_PUBLIC_ADSTERRA_BANNER_MOBILE_HEIGHT
ENV NEXT_PUBLIC_ADSTERRA_BANNER_MOBILE_HEIGHT=${NEXT_PUBLIC_ADSTERRA_BANNER_MOBILE_HEIGHT}
ARG NEXT_PUBLIC_ADSTERRA_BANNER_DOMAIN
ENV NEXT_PUBLIC_ADSTERRA_BANNER_DOMAIN=${NEXT_PUBLIC_ADSTERRA_BANNER_DOMAIN}
ARG NEXT_PUBLIC_ADSTERRA_ROOM_BANNER_KEY
ENV NEXT_PUBLIC_ADSTERRA_ROOM_BANNER_KEY=${NEXT_PUBLIC_ADSTERRA_ROOM_BANNER_KEY}
ARG NEXT_PUBLIC_ADSTERRA_ROOM_BANNER_WIDTH
ENV NEXT_PUBLIC_ADSTERRA_ROOM_BANNER_WIDTH=${NEXT_PUBLIC_ADSTERRA_ROOM_BANNER_WIDTH}
ARG NEXT_PUBLIC_ADSTERRA_ROOM_BANNER_HEIGHT
ENV NEXT_PUBLIC_ADSTERRA_ROOM_BANNER_HEIGHT=${NEXT_PUBLIC_ADSTERRA_ROOM_BANNER_HEIGHT}
ARG NEXT_PUBLIC_ADSTERRA_NATIVE_SRC
ENV NEXT_PUBLIC_ADSTERRA_NATIVE_SRC=${NEXT_PUBLIC_ADSTERRA_NATIVE_SRC}
ARG NEXT_PUBLIC_ADSTERRA_NATIVE_CONTAINER
ENV NEXT_PUBLIC_ADSTERRA_NATIVE_CONTAINER=${NEXT_PUBLIC_ADSTERRA_NATIVE_CONTAINER}
