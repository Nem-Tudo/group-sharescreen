...
export function GiftClaimDialog({ code, onClose }: { code: string; onClose: () => void }) {
    ...
    <>
      ...
      >
        <div
          role="dialog"
          aria-modal="true"
          aria-label="Você recebeu um presente"
          onClick={(e) => e.stopPropagation()}
          className="relative w-full max-w-sm overflow-hidden rounded-3xl border border-black/10 bg-white shadow-2xl dark:border-white/10 dark:bg-zinc-950"
        >
