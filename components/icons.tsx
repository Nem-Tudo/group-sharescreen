...
export function FireIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 23c-4.97 0-9-3.58-9-8 0-3.19 2.13-6.13 4-8 .26-.25.68-.07.68.3 0 2.5 1.5 4 3 4 1.93 0 2.5-1.85 2.5-3 0-2-1-4-2-6-.35-.71-1.27-.66-1.45.08C5.56 9.85 4 12.5 4 15c0 3.87 3.58 7 8 7 4.97 0 8-3.58 8-7 0-3.5-2-6.5-3.5-8.5-.37-.5-1.13-.45-1.35.1-.35.85-.65 1.65-.65 2.4 0 1.5.75 2.5 1.5 2.5s1.5-1 1.5-2c0-2.5-1.5-4.5-2.5-6-.35-.55-1.15-.5-1.4.1C12.5 7.5 11 10 11 13c0 1.5.75 3 1.5 3 .93 0 1.5-1 1.5-2 0-1.5-.75-2.5-1.5-3.5-.35-.5-1.15-.45-1.4.1-.5 1-1 2-1 3 0 2 .75 3.5 1.5 3.5 1 0 1.5-1 1.5-2.5 0-2-1-4-1.5-5.5-.3-.75-1.3-.7-1.5.05-.75 2.5-1.5 5-1.5 7.5 0 3 1.5 5.5 3 5.5 1.5 0 2.5-1.5 2.5-3.5 0-2-1-4-1.5-5.5-.3-.75-1.3-.7-1.5.05-.75 2.5-1.5 5-1.5 7.5 0 3 1.5 5.5 3 5.5 1.5 0 2.5-1.5 2.5-3.5 0-1.5-.75-3-1.5-4-.35-.5-1.15-.45-1.4.1-.5 1-1 2-1 3 0 2 .75 3.5 1.5 3.5 1 0 1.5-1 1.5-2 0-2.5-1.5-5-2-6-.35-.55-1.15-.5-1.4.1C14 12 13 14 13 16c0 2.5 1.5 5 3 5z" />
    </svg>
  );
}
